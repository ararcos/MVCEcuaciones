...
<html>
    ...
    <body>
        ...
        <section id="intro">
            <center><h1>Calcular Ecuacion de Segundo Grado</h1></center>
        </section>
        <section id="maincontent">
        
        <div class="container">
            <h3>Ingrese los valores</h3>
            <h4>Con el formato f(x)= ax^2+bx+c </h4>
            <hr>
            <form action="segundogrado.htm" method="post" class="contactForm" style="width: 500px; height: 230px">
                ...
                <div class="span4 form-group">
                b:
                <input type="text" name="txtB" class="form-control"required/>
                </div>
                <div class="span4 form-group">
                c:
